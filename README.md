...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&duration=3000&pause=900&color=38BDF8&center=true&vCenter=true&width=760&lines=Building+a+strong+foundation+in+software;Learning+cybersecurity+through+hands-on+practice;Curious%2C+consistent%2C+and+always+improving)](https://git.io/typing-svg)
...
| Cybersecurity | Software Development | Continuous Growth |
|:---:|:---:|:---:|
| Security fundamentals, system awareness, and responsible testing | Building practical projects and strengthening programming fundamentals | Learning through documentation, labs, feedback, and consistent practice |
...
![VS Code](https://img.shields.io/badge/VS_Code-0F172A?style=for-the-badge&logo=visual-studio-code&logoColor=22A7F2)

</div>

> These are technologies I currently use or explore while building my foundation; the list is not intended as a claim of mastery.

## Currently Learning

- Network and system security fundamentals
- Secure coding principles and common web security risks
- Python-based scripting and automation
- Git workflows and maintainable project structure
- Practical software development through small, focused projects
...
<sub>Language statistics reflect public repository usage and do not represent proficiency.</sub>
...
![Footer](https://capsule-render.vercel.app/api?type=waving&color=0:22c55e,55:0ea5e9,100:0f172a&height=120&section=footer)
